...
describe('tvtime emotion normalization', () => {
  it('parses a 12_all episode emotion (id 35 → BORED)', () => {
    const r = normalizeEmotions('emotions-3-prod-episode_votes.csv', [
      {
        vote_key: '6997931-10142511-35',
        episode_id: '6997931',
        user_id: '10142511',
        series_name: 'Riverdale',
        season_number: '3',
        episode_number: '16',
      },
    ]);
  ...
  it('parses a movie emotion with UUID key (id 33 → AMUSED)', () => {
    const r = normalizeEmotions('emotions-live-votes.csv', [
      {
        user_id: '6578993',
        uuid: '82409a25-6ecc-4ec5-be45-784ad5f660d4',
        episode_id: '0',
        movie_name: 'Alien Resurrection',
        vote_key: '82409a25-6ecc-4ec5-be45-784ad5f660d4-6578993-33',
      },
    ]);
    expect(r.detected).toBe(1);
    expect(r.candidates[0].normalizedEmotion).toBe('AMUSED');
    expect(r.candidates[0].targetType).toBe('movie');
    expect(r.candidates[0].movieUuid).toBe('82409a25-6ecc-4ec5-be45-784ad5f660d4');
  });

  it('legacy episode_emotion ids are unsupported', () => {
    const r = normalizeEmotions('episode_emotion.csv', [
      {
        created_at: '2017-04-11 02:16:57',
        updated_at: '2017-04-11 02:16:57',
        tv_show_name: 'The Wire',
        episode_season_number: '5',
        episode_number: '10',
        user_id: '10142511',
        episode_id: '348314',
        emotion_id: '3',
...
describe('tvtime emotion dedup', () => {
  ...
  it('retains multiple distinct emotions for one episode', () => {
    const all = [
      ...normalizeEmotions('emotions-3-prod-episode_votes.csv', [
        base('29'),
        base('35'),
        base('39'),
      ]).candidates,
